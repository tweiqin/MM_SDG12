...
<div class="container mt-4">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="chart-container">
                <h3 class="section-title"><i class="fas fa-users me-2"></i>User Registration Trend (Last 4 Months)</h3>
...
// 2. USER REGISTRATION TREND CHART - FIXED VERSION
...
// Function to load user data - UPDATED
async function loadUserData() {
    try {
        const response = await fetch('get_user_data.php');
        const data = await response.json();
        
        console.log('User registration data:', data); // Debug
