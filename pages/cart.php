...
// FIX: Pull and clear the specific cart error message here
$cart_error_message = $_SESSION['cart_error'] ?? null;
unset($_SESSION['cart_error']); 
// NOTE: The general $_SESSION['message'] (for success) is still checked and cleared below if needed.
...
// FIX: Display success message from other pages (like remove-from-cart.php)
...
if (!isset($_SESSION['cart']) || empty($_SESSION['cart'])) {
    ...
    if (!empty($product_ids)) {
        ...
        $ref_values = function($arr) { $refs = []; foreach ($arr as $key => $value) $refs[$key] = &$arr[$key]; return $refs; };
...
<div class="container my-5">
    ...
    <?php else: ?>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th>Image</th> <th>Product Name</th> <th>Price</th> <th>Quantity</th>
                    <th>Total</th>
                    <th>Action</th> 
                </tr>
            </thead>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="update-cart.php" method="POST" style="display: inline;">
                                <input type="hidden" name="product_id" value="<?= $item['product_id']; ?>">
                                <button type="submit" name="action" value="increase" class="btn btn-sm btn-success" <?= !$can_increase ? 'disabled' : ''; ?>>+</button>
                            </form>
                        </td>
