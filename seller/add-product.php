    ...
    function updateFieldState() {
        ...
        for (let i = 0; i < fieldSequence.length; i++) {
            ...
            if (currentFieldEnabled) {
                // ENABLE: Remove disabled and opacity
                ...
                // DISABLE: Apply disabled and gray out
    ...
    <div class="container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3" id="original_price_group" style="opacity: 0.5;">
                ...
                <input type="number" class="form-control" name="original_price" id="original_price" step="0.01" value="<?= htmlspecialchars($_POST['original_price'] ?? ''); ?>" disabled>
            </div>
            
            <div class="form-group mb-3" id="price_group" style="opacity: 0.5;">
                <label for="price">Price (Discounted/Selling Price):</label>
                <input type="number" class="form-control" name="price" id="price" step="0.01" required value="<?= htmlspecialchars($_POST['price'] ?? ''); ?>" disabled>
            </div>
            ...
            <div class="form-group mb-3" id="quantity_group" style="opacity: 0.5;">
                ...
                <input type="number" class="form-control" name="quantity" id="quantity" min="1" required value="<?= htmlspecialchars($_POST['quantity'] ?? ''); ?>" disabled>
            </div>
