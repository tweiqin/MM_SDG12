...
$message = ""; // Initialize message variable for success/error alerts
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !isset($_POST['change_password'])) {
    ...
    // SECURITY FIX: Use Prepared Statement for secure update
    $update_query = "UPDATE users SET name = ?, email = ?, address = ?, phone = ? WHERE user_id = ?";
    $update_stmt = $conn->prepare($update_query);

    // Types: s=name, s=email, s=address, s=phone, i=user_id
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form action="profile.php" method="POST" id="password-form">
                        ...
                        <div class="text-center">
                            <button type="submit" name="change_password" id="change-password-btn" class="btn btn-primary px-4" disabled>
...
#new_password:focus, #confirm_password:focus, #current_password:focus {
    border-color: #80bdff;
