...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($_POST['review'] as $product_id => $review_data) {
        ...
        if ($rating >= 1 && !empty($review_text)) {
            ...
            // Check if review exists using order_id and product_id (prevents double form submission)
            ...
            if ($check_stmt->get_result()->num_rows == 0) {
                ...
                // Secure INSERT query with the new order_id column
...
<div class="container my-5">
    ...
    <form method="POST"
        onsubmit="return confirm('Once you submit the review, you won\'t be able to edit again. Submit the review?');">
        <?php
                ...
                <div class="card mb-4 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="review[<?= $product['product_id']; ?>][text]" rows="3"
                                required></textarea>
                        </div>
                    </div>
                </div>
