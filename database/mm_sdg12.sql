...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2025 at 08:05 PM
...
(7, 6, 'Chicken Box', 9.00, 8.00, 'Hotels', 'Operation hours: 10am - 10pm\r\nPick up time: 8pm', 'chicken.jpg', 3, '2025-10-28 14:56:11', 'Available'),
(8, 2, 'Fish Mystery Box', 15.00, 6.00, 'Hotels', 'Operation hours: 9am - 3pm\r\nPick up time: 12pm', 'fish.jpg', 3, '2025-10-28 14:59:43', 'Available'),
(10, 2, 'Vege Petite', 8.00, 4.00, 'Hotels', 'Operation Hours: 6am - 10am\r\nPick-up Time: 9am', 'petite-vege.jpg', 1, '2025-10-29 06:57:20', 'Available'),
(12, 6, 'Pastry Mystery Box', 12.00, 5.00, 'Bakeries', 'Breads and pastries for sale', 'pastry.jpg', 1, '2025-10-30 09:34:11', 'Available'),
(13, 2, 'Hotel Mystery Ticket', 25.00, 10.00, 'Hotels', 'Just head over the hotel', 'buffet.jpg', 3, '2025-10-30 13:40:30', 'Available'),
(14, 6, 'Beef Mystery Box', 8.00, 6.00, 'Hotels', 'Operation Hours: 12pm - 3pm\r\nPick-up time: 2pm', 'beef.jpg', 1, '2025-10-31 04:48:29', 'Available'),
(15, 2, 'Seafood Mystery Box', 6.00, 8.00, 'Resaturants & Cafes', 'Operation Hours: 24/7', 'seafood.jpg', 3, '2025-10-31 09:16:15', 'Available'),
(19, 2, 'Siew Yok', 12.00, 8.00, 'restaurants & cafes', 'Pick Up Time: 2pm', 'pork.jpg', 1, '2025-11-15 04:21:03', 'Available'),
...
(22, 8, 'Lamb Box', 15.00, 10.00, 'restaurants & cafes', 'Ops Hours: 12:00- 22:00\r\nPick-up Time: 20:00 - 21:00\r\n', 'lamb.jpg', 0, '2025-11-19 16:15:13', 'Available'),
(23, 2, 'Seafood - Petite', 15.99, 10.00, 'Resaturants & Cafes', 'Pick-up Time: 17:00 - 18:00\r\nHalal\r\n', 'spaghetti.jpg', 1, '2025-11-25 14:05:56', 'Available'),
(24, 8, 'Sushi Box', 20.99, 13.99, 'restaurants & cafes', 'Ops Hours: 11:00- 21:00\r\njpg for illustration purpose', 'sushi.jpg', 2, '2025-11-25 14:13:15', 'Available'),
...
(28, 10, 'Vegetarian Friendly', 23.80, 13.90, 'Resaturants & Cafes', 'Ops Hours: 11:00- 21:00\r\n', 'spaghetti.jpg', 2, '2025-11-26 07:57:27', 'Available'),
(30, 15, 'Dau Sah Piah', 28.88, 20.00, 'Bakeries', 'Pick-up Time: Anytime', 'sushi.jpg', 2, '2025-11-26 15:08:20', 'Available'),
(31, 17, 'Nigiri Sushi Box', 18.80, 12.00, 'restaurants & cafes', 'Ops Hours: 11:30 - 21:30\r\n', 'nigiri.jpg', 1, '2025-12-04 06:34:59', 'Available'),
(32, 18, 'Breakfast Buffet', 45.00, 20.00, 'hotels', 'Dine-in: 10:30 - 11:30am\r\n', 'ticket.jpg', 2, '2025-12-13 18:05:09', 'Available');
...
(5, 'Wei Xuan', 'xuantay98@gmail.com', '010-7600532', '381, Jalan Indah, Taman Indah, 84000 Muar, Johor.', NULL, NULL, '$2y$10$bsuqE/Wf2iT3QRtb8haxi.OaQC3oyMlfwi/I.pdUsyx0.RIiShv.S', 'buyer', NULL, 1, '2025-10-27 09:19:15'),
...
(7, 'Cheong Hao Sheng', 'ericcheong19@gmail.com', '012-6378720', '11, Jalan BK5/B, 47000 Puchong', NULL, NULL, '$2y$10$WYxRe4OyTUreNR2cKIEdROvMOkwz6UtZDd6tEw0FUkflfWNrIKzJe', 'buyer', NULL, 1, '2025-10-30 09:35:52'),
...
(10, 'Arin Nasi Lemak', 'arin@gmail.com', '6011-28809573', 'Jalan TPK 2/8, Taman Perindustrian Kinrara, 47170 Selangor.', 3.04749400, 101.63739600, '$2y$10$d/HWo9ELYM0dWxU6DEkUpOKgi.ystI4tiV0UGTDGiU.wC3sskCxkS', 'seller', 'arin.jpg', 1, '2025-11-26 07:56:41'),
...
(17, 'Shin Zushi', 'zushi@gmail.com', '+6014-9509946', 'Jalan Jalil Jaya 7, Bukit Jalil, 57000 Kuala Lumpur, Malaysia.', 3.06012600, 101.67294200, '$2y$10$Y.J296FFvRdVazfOGjU.jeg4GHt1eoclPEGh4kHPFf/AkT09c1wRu', 'seller', 'shin.jpg', 1, '2025-12-04 06:24:07'),
...
--
ALTER TABLE `orders`
  MODIFY `order_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `order_items`
--
ALTER TABLE `order_items`
  MODIFY `item_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE `products`
  MODIFY `product_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
